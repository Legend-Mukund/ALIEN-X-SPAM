...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await ydk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await wdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await hdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await sdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await adk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await adk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await adk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await bdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await cdk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await ddk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await edk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await edk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await edk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await vkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await kkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await lkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await mkk(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await sid(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await sid(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await sid(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await shy(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await shy(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await shy(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await aan(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await aan(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await aan(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await ake(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await ake(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await ake(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await eel(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await eel(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await eel(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await khu(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await khu(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await khu(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await shi(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await shi(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await shi(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await yaa(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await dav(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await dav(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await dav(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await raj(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await raj(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await raj(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SUPPORT"))
            await put(functions.channels.JoinChannelRequest(channel="@ALIEN_X_UPDATE"))
            await put(functions.channels.JoinChannelRequest(channel="@Sharedsecrets"))
            await put(functions.channels.JoinChannelRequest(channel="@ALIEN_X_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
